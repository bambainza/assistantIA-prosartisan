...
4. **Webhooks Mobile Money** : signature `X-Signature` HMAC SHA-256 obligatoire ; absente ou invalide → `401` systématique, jamais optionnel. Paiement abouti crédité uniquement si `montant` = montant de la transaction (`400` sinon).

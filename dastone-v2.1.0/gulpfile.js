...
//  Producation Task
gulp.task('default', gulp.series(gulp.parallel('clean:packageLock', 'copy:all', 'copy:libs', 'fileinclude', 'scss', 'bootstrap', 'icons', 'js', 'jsPages', 'html'), gulp.parallel('browsersync', 'watch')));

//  Build Task
gulp.task('build', gulp.series(gulp.parallel('clean:packageLock', 'copy:all', 'copy:libs', 'fileinclude', 'scss', 'bootstrap', 'icons', 'js', 'jsPages', 'html')));

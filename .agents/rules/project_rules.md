...
- **Modèles ORM** : toute évolution s'accompagne d'une migration Alembic, et tout nouveau modèle est importé dans `app/models/__init__.py` (requis par les scripts `app/scripts/`, qui ne chargent pas `app.main`).
